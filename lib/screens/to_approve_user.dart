...
class to_approve_user extends StatefulWidget {
  ...
  int emp_ind;
  to_approve_user(this.emp_ind, {super.key});
  @override
  // ignore: no_logic_in_create_state
  State<StatefulWidget> createState() => to_approve_userState(emp_ind);
}

class to_approve_userState extends State<to_approve_user> {

  int emp_ind;
  to_approve_userState(this.emp_ind);
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => transfer(emp_ind),));
                                        },
                                        child: Container(
                                          width: double.infinity,
                                          height: 40,
